...
import SignInContainer from "@/features/authentication/components/SignInContainer";
import SignUpContainer from "@/features/authentication/components/SignUpContainer";
          ...
          <div className="w-11/12 max-w-[1920px] min-w-[300px] h-auto flex flex-col md:justify-center items-center mt-[5rem]">
            {shouldSignInDisplay ? (
              <div
                ...
                className=" min-w-[300px] max-w-[600px] w-full md:w-3/4 z-10 "
              >
                <SignInContainer
                  setShouldSignInDisplay={setShouldSignInDisplay}
                />
              </div>
            ) : (
              <div
