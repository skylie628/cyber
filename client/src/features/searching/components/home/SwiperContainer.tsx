...
const SwiperContainer: React.FC<SwiperContainerProps> = (props) => {
  ...
  return isXs ? (
            ...
            return (
              <React.Fragment key={index}>
                ...
                sectionName === "history" ? (
                  ...
                  <ButtonMediaCard
                    role={
                      mediaType === "movie" ? "buttonMovieCard" : "buttonTVCard"
                    }
                    handleButtonClick={() => {
                      sectionName &&
                        sectionBackdropItems.setSectionBackdropItem(
                          sectionName,
                          media
                        );
                    }}
                    ...
                    styles={{
                      ...
                      ${
                        sectionName
                          ? sectionBackdropItems.getSectionBackdropItem(
                              sectionName
                            )?.id === media.id
    ...
    <div
      className={`relative z-20 w-full h-[24rem] overflow-hidden ${styles?.swiper}`}
    >
      <ButtonComponent
