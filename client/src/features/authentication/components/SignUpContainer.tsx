    ...
    <div className="w-full h-full p-4 flex flex-col justify-start items-center font-poppins bg-transparent">
      ...
      <FormComponent
        styles={{
          ...
          input:
            "w-full py-2 px-4 mt-2 text-stone-900 shadow-inner rounded-lg outline-none focus:ring-2 focus:ring-stone-900 bg-white text-base",
          inputName:
        ...
        submitFn={(formInputs: any) => {
          ...
          return signUpMutation.mutate(formInputs, {
            onError: (e: any) => {
              console.log("err la", e.message);
        ...
        options={[
          { extras: { type: "text", placeholder: "ItsMuvize" }, name: "name" },
          {
            extras: { type: "text", placeholder: "ItsMuvize@gmail.com" },
            name: "email",
          },
          {
            extras: { type: "password", placeholder: "1234567" },
            name: "password",
          },
          {
      ...
      <Link
        to="/"
        className="mt-8 text-white text-base  hover:underline  mb-16"
      >
