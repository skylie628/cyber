import { ShowQueryResponseType } from "../../type";
...
const ProfileMediaCard = (props: ProfileMediaCardProps) => {
  ...
  return (
    <article className="w-[200px] rounded-lg shadow-md shadow-slate-300 dark:shadow-sm dark:shadow-stone-500 flex flex-col justify-center items-center bg-slate-100 dark:bg-stone-800 transition-full duration-200">
      <Link
      ...
      >
        ...
        <div className={`w-full px-4 flex flex-col my-4 `}>
          ...
          <div className="flex justify-between font-poppins text-slate-700 dark:text-stone-400 text-sm">
            <p>
              Last updated:{" "}
              <time className="text-slate-700 dark:text-stone-400">
