...
const ButtonMediaCard: React.FC<ButtonMediaCardProps> = (props) => {
  ...
  return (
    <ButtonComponent
      ...
      className={`${styles?.button} font-poppins relative`}
    >
      ...
      {role === "buttonMovieCard" ? (
        <div
          className={
            styles?.detail ??
            "flex flex-col pb-2 absolute  inset-0 bg-gradient-to-t from-stone-900 to-transparent px-4 w-full"
          }
        >
          ...
          <div className="flex text-sm tracking-[0.2rem]">
            ...
            <p className="ml-auto px-2 bg-amber-100 rounded-lg shadow-md text-base grid place-items-center text-yellow-600 font-semibold tracking-[0.1rem] dark:bg-stone-900 dark:text-yellow-500">
