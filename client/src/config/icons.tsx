...
<MdDarkMode />;
export const iconHelper: Record<string, (className: string) => JSX.Element> = {
  ...
  question: (className: string) => (
    <AiOutlineQuestionCircle className={className} />
  ),
  ...
  systemUpdate: (className: string) => (
    <MdSystemUpdateAlt className={className} />
  ),
  trailer: (className: string) => (
    <TfiLayoutMediaCenterAlt className={className} />
  ),
