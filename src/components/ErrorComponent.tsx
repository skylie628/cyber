...
const ErrorComponent: React.FC<ErrorComponentProps> = (props) => {
  ...
  return (
    ...
    >
      <h1 className="text-base text-stone-900  bg-slate-200 round-md px-4 py-[3px] flex gap-2 items-center dark:bg-stone-800 dark:text-white">
        {iconHelper.exclamation("text-1x1")}
